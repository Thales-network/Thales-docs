...
description: How to vote on a proposal so that it is enacted or rejected on Thales via governance features
---
...
|        Variable         |     |                                                         Value                                                         |
| :---------------------: | :-: | :-------------------------------------------------------------------------------------------------------------------: |
|       Vote Period       |     |  {{ networks.thalesbase.democracy.vote_period.blocks}} blocks ({{ networks.thalesbase.democracy.vote_period.days}} days)  |
|      Enact Period       |     | {{ networks.thalesbase.democracy.enact_period.blocks}} blocks ({{ networks.thalesbase.democracy.enact_period.days}} days) |
| Maximum Number of Votes |     |                                      {{ networks.thalesbase.democracy.max_votes}}                                       |
...
!!! note
    The lockup periods shown in the previous image are not to be taken as reference. This guide was done with a customized version of Thales with short Launch/Enactment periods for demonstration purposes only.
