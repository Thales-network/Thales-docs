...
description: Learn how to deploy unmodified and unchanged Solidity-based smart contracts to a Thales node with a simple script using Web3.js, Ethers.js, or Web3.py.
---

# Using Ethereum Libraries to Deploy Smart Contracts on Thales

![Ethereum Libraries Integrations Thales](/images/sendtx/web3-libraries-banner.png)

## Introduction

This guide walks through using the Solidity compiler and three different Ethereum libraries to sign and send a transaction on Thales manually. The three libraries covered by this tutorial are:
...
The setup for this example will be relatively simple, and it'll contain the following files:
 ...
 - **_deploy.\*_**: it will handle the deployment to our local Thales node
 - **_get.\*_** — it will make a call to the node to get the current value of the number
 - **_increment.\*_** — it will make a transaction to increment the number stored on the Thales node
